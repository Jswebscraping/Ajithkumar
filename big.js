...
const get_price = async (page, i) => {
    try {
        await page.waitForXPath(`//*[@id="dynamicDirective"]/product-deck/section/div[2]/div[4]/div[1]/div/div/div[2]/div/div[${i}]/product-template/div/div[4]/div[3]/div/div[1]/h4/span/span[2]`, { timeout: 10000 });
        ...
        try {
            await page.waitForXPath(`//*[@id="dynamicDirective"]/product-deck/section/div[2]/div[4]/div[1]/div/div/div[2]/div/div[${i}]/product-template/div/div[4]/div[3]/div/div[1]/h4/span[2]/span`, { timeout: 10000 });
