    ...
    (err, client) => {
        ...
        (async () => {
            ...
            while (1) {
                try {
                    for (j = 1; j <= 4; j++) {
                        await page.waitForXPath(`//*[@id="container"]/div/div[3]/div[1]/div[2]/div[${i}]/div/div[${j}]/div/a[2]`, { timeout: 10000 });
                        ...
                        await page.waitForXPath(`//*[@id="container"]/div/div[3]/div[1]/div[2]/div[${i}]/div/div[${j}]/div/a[3]/div/div[1]`, { timeout: 10000 });
                        ...
                        try {
                            await page.waitForXPath(`/html/body/div[1]/div/div[3]/div[1]/div[2]/div[${i}]/div/div[${j}]/div/div[2]/span[1]/div`, { timeout: 10000 });
